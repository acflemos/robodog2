...
| [lava_tube.world](lava_tube.world) | Lava tube lunar (1/6g), corredor oco em caixa (paredes com espessura), câmara final com enigma. Gerado por [generate_lava_tube.py](generate_lava_tube.py). | `rbd_lava_tube` |
