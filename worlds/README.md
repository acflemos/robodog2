...
| [lava_tube.world](lava_tube.world) | Lava tube lunar (1/6g), perfil meio-cilindro (Hawaii-style), rocha vulcânica nas paredes, câmara final com enigma arqueológico. Gerado por [generate_lava_tube.py](generate_lava_tube.py). | `rbd_lava_tube` |
