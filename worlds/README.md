...
| [lava_tube_fuel.world](lava_tube_fuel.world) | Protótipo com meshes Fuel (Cave Straight 02 Type B + Cap). Descarrega da internet na 1ª execução. | `rbd_lava_tube_fuel` |
