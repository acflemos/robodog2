...
def generate_launch_description():
    ...
    imu_filter_config = os.path.join(pkg_robodog2, 'yahboomcar_bringup', 'param', 'imu_filter_param.yaml')
    default_rviz_config = os.path.join(pkg_robodog2, 'yahboomcar_nav', 'rviz', 'nav.rviz')
